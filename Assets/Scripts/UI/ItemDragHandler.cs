    ...
    IPointerEnterHandler, IPointerExitHandler, IPointerUpHandler
{
    ...
    private InputAction _quickAddItemAction;
    private InputAction _quickDropItemAction;
    ...
    private void SubscribeInputEvents()
    {
        ...
        _quickAddItemAction.performed += OnQuickAddItemAction;
        _quickDropItemAction.performed += OnQuickDropItemAction;
    }
    ...
    public void Init(ItemInstance item, InventoryUIPresenter presenter, 
        InputAction rotateItemAction, InputAction quickAddItemAction, InputAction quickDropItemAction, Transform uiParent)
    {
        ...
        _rotateItemAction = rotateItemAction;
        _quickAddItemAction = quickAddItemAction;
        _quickDropItemAction = quickDropItemAction;
        SubscribeInputEvents();
    }
